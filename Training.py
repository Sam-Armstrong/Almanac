...
class Train():
    ...
    def test(self):
        ...
        odds_df = pandas.read_csv('TestOdds6.csv')
        i = 0
        returns = 0
        t_est = 0
        num_correct = 0
    ...
    def train(self, training_data):
        ...
        criterion = nn.CrossEntropyLoss(weight = torch.tensor([2.284565, 3.82468, 3.324247]).to(self.device)) #nn.L1Loss() #nn.MSELoss() #nn.CrossEntropyLoss()
        ...
        optimizer = optim.Adam(self.model.parameters(), lr = 5e-2, weight_decay = 0)
